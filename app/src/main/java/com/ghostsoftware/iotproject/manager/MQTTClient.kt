package com.ghostsoftware.iotproject.manager
...
class MQTTClient {
    ...
    fun connect(applicationContext : Context) {
        mqttAndroidClient = MqttAndroidClient ( applicationContext,"a34bt8gk372w9w-ats.iot.us-east-2.amazonaws.com","YOUR CLIENT ID" )
        try {
